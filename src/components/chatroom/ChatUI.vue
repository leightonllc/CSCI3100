/**
 * @Author: monkeyjai78
 * @Description: /component/chatroom/ChatUI.vue is a page showing all user available to chat with. 
 *              By clicking into a user, it directs to the PrivateChat.vue to have a chat.
 * @Date: 2022-05-06 20:48:07
 * @Last Modified by:   meganmhl
 * @Last Modified time: 2022-05-06 20:53:00
 */
