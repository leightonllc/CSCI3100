/**
 * @Author: ethanwongys
 * @Description: /views/CourseList.vue is the course list page for user choosing and clicking into a course.
 *              User can (1) see all courses, (2) search a course by any field, and (3) click into a course.
 * @Date: 2022-05-06 20:17:39
 * @Last Modified by:   meganmhl
 * @Last Modified time: 2022-05-06 20:20:06
 */
                    ...
                    <div class="my-2 overflow-auto">
                        <p style="font-family:Segoe UI">
                            <DataTable :value="courses" :paginator="true" :rows="5" data-key="id" :filters="filters"
                                :selection="selected" selectionMode="single" @rowSelect="handleClick">
                                <template #header>
